...
class ArchitectureTest {
    ...
    void layerDependenciesAreRespected() {
        layeredArchitecture()
                ...
                .layer("Controller")
                .definedBy("com.auditlog.controller..")
                .layer("Facade")
                .definedBy("com.auditlog.facade..")
                .layer("Service")
                .definedBy("com.auditlog.service..")
                .layer("DAO")
                .definedBy("com.auditlog.dao..")
                .layer("DTO")
                .definedBy("com.auditlog.dto..")
                .whereLayer("Controller")
                .mayNotBeAccessedByAnyLayer()
                .whereLayer("Facade")
                .mayOnlyBeAccessedByLayers("Controller")
                .whereLayer("Service")
                .mayOnlyBeAccessedByLayers("Facade", "Service")
                .whereLayer("DAO")
                .mayOnlyBeAccessedByLayers("Service")
                .whereLayer("DTO")
                .mayOnlyBeAccessedByLayers("Controller", "Facade", "Service", "DAO")
                .check(classes);
    }
